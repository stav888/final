...
ה־Sweet Spot הוא הנקודה שבה השיפור נהיה קטן — “השבר” בגרף (המרפק).  
דוגמה נוספת: K-Means — בוחרים את מספר האשכולות K לפי גרף Elbow של WCSS/Inertia מול K.
...
**תשובה:**  
מצביעים על המחלקה הכי נפוצה בין K השכנים (Majority Vote).
...
**תשובה:**  
מחשבים ממוצע (לפעמים ממוצע משוקלל לפי מרחק) של הערכים של K השכנים.
...
**תשובה:**  
ככל שיש יותר פיצ'רים, קשה יותר למדוד “קרבה” בצורה טובה (Curse of Dimensionality), ולכן הביצועים יכולים לרדת.
...
**תשובה:**  
איטי בחיזוי על דאטה גדול, רגיש לסקייל של פיצ'רים (צריך נרמול), מושפע מרעש וממימדיות גבוהה.
