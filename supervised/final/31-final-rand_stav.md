...
**תשובה:**  
Random Forest בונה מאות עצי החלטה (Decision Trees) קטנים ונפרדים. 
כדי שהעצים יהיו שונים זה מזה, כל עץ מאומן על חלק אקראי מהנתונים (Bootstrap), ובכל פיצול בודקים רק חלק קטן ואקראי מהמשתנים.  
התשובה הסופית היא הצבעה רוב (בסיווג) או ממוצע (ברגרסיה) של כל העצים.  
ככה המודל הרבה יותר יציב ומדויק מעץ החלטה אחד, ופחות נוטה ל"לימוד בעל פה" (overfitting).  
